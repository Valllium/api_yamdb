    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(db_index=True, help_text='Год в формате YYYY', validators=[django.core.validators.MaxValueValidator(2022, message='Такой год еще не наступил!'), django.core.validators.MinValueValidator(1000, message='Слишком ранняя дата!'), django.core.validators.RegexValidator(message='Введите год в формате YYYY!', regex='^/d{4}$')], verbose_name='Год создания')),
